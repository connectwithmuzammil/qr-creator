        ...
        <div className="content">
          <div className="wrap">
            ...
            <p>
              ...
              your own QR codes and then manage them once they're out there in
              the world.
            </p>
            <p>
            ...
            <p>
              Are you an event planner who wants to make sure everyone knows
              about your event, but doesn't want to spend all day making flyers?
              Let us help!
            </p>
            <p>
              We can help generate QR codes for all of your marketing materials,
              so you can get back to doing what you love: managing your
              business!
            </p>
            <div className="bottom-con">
              ...
              <ul>
                <li>
                  Generate unlimited numbers of dynamic QR codes that look
